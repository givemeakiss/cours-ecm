...
<body>
        ...
        <form class="form-inline">
            <div class="form-group">
                ...
                <input type="text" data-role="tags" data-service-url="/tags.json" data-limit="1" class="form-control" id="tag" placeholder="Tag" name="tag" value="${fn:escapeXml(searchedTag)}" style="width: 200px;">
            </div>
